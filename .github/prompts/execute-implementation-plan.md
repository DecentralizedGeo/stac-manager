...
### Objective
Execute **[PHASE_NAME]** for STAC Manager using the `@[.agent/skills/executing-plans/SKILL.md]` skill.
...
- **Refactor Phase**: Review the code for duplicates or non-Pythonic patterns as per `.agent/AGENTS.md`. Ensure type hints (Generics, etc.) are perfect.
