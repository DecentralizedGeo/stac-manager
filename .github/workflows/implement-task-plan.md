...
2. **Review Blueprint**: Read the target implementation plan in `docs/plans/`. If you find ambiguous logic, STOP and brainstorm via `@brainstorming`.
...
2. **Consolidate Memory**: Using `@agent-memory`, record newly learned technical quirks, patterns, or pits in `semantic.md` or `procedural.md`.
