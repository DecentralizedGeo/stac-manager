...
// turbo
1. **Recall Memory**: Use the `@agent-memory` skill to read existing decisions, semantic mapping, and procedural standards.
...
3. **Initialize if New**: If this is a new project, create the `.agent/memory/` directory and seed it with the "Project Vision" from the blueprint.
...
3. **Brainstorming**: If you encounter ambiguous paths, invoke `@brainstorming` to propose 2-3 approaches with trade-offs.
